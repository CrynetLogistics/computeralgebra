...
public class Raytrace {
	...
	//LAUNCH PARAMETERS: 0 FOR NORMAL COLOUR; 1 FOR RAINBOW COLOURS; 
	//          10 FOR JULIA SETS; 20 FOR POWERING PIXELS; 30 FOR MANDELBROT WITH COMPLEX POWERS
	...
	public static void main(String[] args){
		...
		//zoom.setCentreX(0);  /////////////////////////////////////////////////////////////////////
		//zoom.setCentreY(0);/////////////////////////////////////////////////////////////////////
		//zoom.setSampleInterval(0.0025);  //////////////////////////////////////////////////////////
		////zoom.setSampleInterval(0.004);  //////////////////////////////////////////////////////////
		//zoom.setNumberOfIterations(50);//////////////////////////////////////////////////////////
		...
		f.addMouseListener(new MouseInterpreter(zoom));
	}
